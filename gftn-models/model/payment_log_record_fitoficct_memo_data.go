...
// swagger:model paymentLogRecordFitoficctMemoData
...
func (m *PaymentLogRecordFitoficctMemoData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentLogRecordFitoficctMemoData) validateFitoficctPiiHash(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) validateFitoficctnonpiidata(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) validateID(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) validateMessageName(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) validateMessageType(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) validateOfiID(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) validateTimeStamp(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) validateTransactionStatus(formats strfmt.Registry) error {
...
func (m *PaymentLogRecordFitoficctMemoData) UnmarshalBinary(b []byte) error {
	var res PaymentLogRecordFitoficctMemoData
