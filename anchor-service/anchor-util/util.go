...
func AllowTrustForDigitalAsset(gClient gasserviceclient.GasServiceClient, trustorAddress string, anchorAddress string,
	assetCode string, authorize bool, secretsSession secrets.Client) (error, string) {
	...
	*/
	...
	ibmAdminAccount, err := secretsSession.GetAccount(domainId, common.MASTER_ACCOUNT)
	if err != nil {
