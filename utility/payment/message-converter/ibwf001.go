...
import (
	...
	ibwf "github.ibm.com/gftn/iso20022/ibwf00100101"
	pbstruct "github.ibm.com/gftn/iso20022/proto/github.ibm.com/gftn/iso20022/ibwf00100101"
...
func (msg *Ibwf001) SanityCheck(bic, participantId string) error {
	...
	LOGGER.Infof("Received IBWF.001 with instruction ID: %v", string(msg.Message.Body.ResBody[0].Id))
