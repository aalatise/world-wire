...
import (
	...
	camt "github.ibm.com/gftn/iso20022/camt02900109"
	pbstruct "github.ibm.com/gftn/iso20022/proto/github.ibm.com/gftn/iso20022/camt02900109"
...
func (msg *Camt029) ProtobuftoStruct() (*sendmodel.XMLData, error) {
	...
	instructionId := string(*msg.Message.Body.Assgnmt.Id)
