...
if [ $ENVIRONMENT == dev ]; then
  ...
  FIREBASEURL="https:\/\/dev-world-wire-addcf.firebaseio.com"
  ENABLEJWT="false"
  ...
  HORIZONURL="http:\/\/34.80.67.4:1234"
  STELLARNETWORK="Standalone World Wire Network ; Mar 2019"
  FIREBASEURL="https:\/\/qa-world-wire-b61ef.firebaseio.com"
  ENABLEJWT="true"
  ...
  HORIZONURL="http:\/\/34.80.67.4:1234"
  STELLARNETWORK="Standalone World Wire Network ; Mar 2019"
  FIREBASEURL="https:\/\/staging-world-wire-efac5.firebaseio.com"
  ENABLEJWT="false"
  ...
  FIREBASEURL="https:\/\/test-world-wire-22fc3.firebaseio.com"
  ENABLEJWT="true"
  ...
  FIREBASEURL="https:\/\/live-world-wire-97e03.firebaseio.com"
  ENABLEJWT="true"
  ...
  HORIZONURL="https:\/\/horizon.stellar.org"
  STELLARNETWORK="Public Global Stellar Network ; September 2015"
  FIREBASEURL="https:\/\/pen-world-wire.firebaseio.com"
  ENABLEJWT="true"
fi
