...
var (
	...
	StatusCreateVaultSecretsFailed     = "create_vault_secrets_failed"
	StatusReady                        = "ready"
	...
	// Internal k8s url for vault service
	VaultAddress      = "https://vault.vault.svc:8200"
	VaultTokenPodPath = "/vault/secrets/token"
	VaultBasePath     = "ww/data/sandbox/"

	DeployLockMongoCollectionName = "deploy-lock"
	PortalDBMongoDatabaseName     = "portal-db"

	GFTNMongoDBName                = "GFTN"
	WhitelistMongoDBCollectionName = "whitelist"
)
