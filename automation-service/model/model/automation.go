...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["pending","configuring","configuration_failed","complete","create_participant_entry_failed","create_kafka_topic_failed","create_vault_secrets_failed","create_micro_services_failed","create_issuing_account_failed","create_operating_account_failed","deleted"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
