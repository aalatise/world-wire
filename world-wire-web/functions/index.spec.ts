...
const config = {
    apiKey: "AIzaSyDEWj72xAwiTacjN2Vj5MzmVDEaG8Re5RI",
    authDomain: "next-world-wire.firebaseapp.com",
    databaseURL: "https://next-world-wire.firebaseio.com",
    projectId: "next-world-wire",
    storageBucket: "next-world-wire.appspot.com",
    messagingSenderId: "822753698414"
};

const serviceAccount = './../src/_next-world-wire-firebase-adminsdk-wvjz8-67ea263932.json';
...
// staging env (ie: next-world-wire) firebase project
