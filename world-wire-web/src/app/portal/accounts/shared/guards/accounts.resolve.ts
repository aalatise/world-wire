    ...
    resolve(
        ...
        return new Promise(async (resolve) => {
            ...
            if (this.sessionService.currentNode) {
                this.accountService.apiRoot = `${ENVIRONMENT.envApiRoot}/${this.sessionService.currentNode.participantId}/api`,

                this.accountService.globalRoot = `${ENVIRONMENT.envGlobalRoot}`;
