...
export class AccountModalComponent extends BaseModal implements OnInit {
  ...
  public async requestAccountRequest() {
    ...
    try {
      ...
      this.portalApiService.createAccountRequest(this.sessionService.currentNode.participantId, requestBody).subscribe();
  ...
  public async rejectAccountRequest() {
    ...
    try {
      ...
      this.portalApiService.updateAccountRequest(this.sessionService.currentNode.participantId, this.currentAccountRequest.name, {approvalIds: newApprovalIds}).subscribe();
