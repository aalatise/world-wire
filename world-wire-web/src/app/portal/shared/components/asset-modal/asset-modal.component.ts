...
export class AssetModalComponent extends BaseModal implements OnInit {
   ...
   * @memberof AssetModalComponent
   */
  public async requestAssetRequest() {
    ...
    try {
      ...
      this.portalApiService.createAssetRequest(this.sessionService.currentNode.participantId, requestBody).subscribe();
  ...
  public async rejectAssetRequest() {
    ...
    try {
      ...
      this.portalApiService.updateAssetRequest(
        {
          participantId: this.sessionService.currentNode.participantId,
          approvalIds: newApprovalIds,
          asset_type: this.currentAssetRequest.asset_type,
          asset_code: this.currentAssetRequest.asset_code,
        }).subscribe();
