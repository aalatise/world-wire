...
import { PortalApiService, PortalApiServiceHelper, PortalApiServiceModelTransformer } from './services/portal-api.service';
...
@NgModule({
    ...
    providers: [
        ...
        PortalApiService,
        PortalApiServiceHelper,
        PortalApiServiceModelTransformer,
