...
comment='// ' \
fromPath='../world-wire-web/src/app/shared/models/token.interface.d.ts' \
toPath='./authentication/src/shared/models/token.interface.d.ts' \
node ./project-provisioning/src/copy_file.js

comment='// ' \
fromPath='../world-wire-web/src/app/shared/models/user.interface.d.ts' \
toPath='./authentication/src/shared/models/user.interface.d.ts' \
node ./project-provisioning/src/copy_file.js

comment='// ' \
fromPath='../world-wire-web/src/app/shared/models/account.interface.d.ts' \
toPath='./authentication/src/shared/models/account.interface.d.ts' \
node ./project-provisioning/src/copy_file.js

comment='// ' \
fromPath='../world-wire-web/src/app/shared/models/approval.interface.d.ts' \
toPath='./authentication/src/shared/models/approval.interface.d.ts' \
node ./project-provisioning/src/copy_file.js

comment='// ' \
fromPath='../world-wire-web/src/app/shared/models/participant.interface.d.ts' \
toPath='./authentication/src/shared/models/participant.interface.d.ts' \
node ./project-provisioning/src/copy_file.js

comment='// ' \
fromPath='../world-wire-web/src/app/shared/models/asset.interface.d.ts' \
toPath='./authentication/src/shared/models/asset.interface.d.ts' \
node ./project-provisioning/src/copy_file.js

comment='// ' \
fromPath='../world-wire-web/src/app/shared/models/node.interface.d.ts' \
