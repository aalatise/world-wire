...
export const microServices: IMicroServiceDef = {
    'micro-services/participant': {
        ...
        swagger: {
            ...
            host: 'participant-portal-service-dot-next-world-wire.appspot.com'
        },
        tsoa:{
            controllerFiles:[
    ...
    'micro-services/public': {
        ...
        swagger: {
            ...
            host: 'public-portal-service-dot-next-world-wire.appspot.com'
        },
        tsoa:{
            controllerFiles:[
                'ibmid.controller.ts',
    ...
    'micro-services/super': {
        ...
        swagger: {
            ...
            host: 'super-portal-service-dot-next-world-wire.appspot.com'
        },
        tsoa:{
            controllerFiles:[
