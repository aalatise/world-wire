...
printf "$(tput setaf 3)Go to $(tput bold)https://travis.ibm.com/gftn/world-wire-services/settings$(tput sgr0)$(tput setaf 3) and the following decryption secrets: $(tput sgr0)\n"
printf "${deployKeys}"
