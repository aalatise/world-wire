...
class main {
    ...
    async setCurrentVersion() {
        ...
        if(versionsFound.length <= 0){
            console.log('No un-encrypted .credentials-v{VERSION_NUMBER} available. Unable to rotate. Please download () and extract into ./world-wire-services/auth-service and re-run');            
            process.exit(1);
        }
