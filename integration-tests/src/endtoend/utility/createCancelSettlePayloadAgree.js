...
module.exports = async(
    ...
    try {
        ...
        let RFI_CANCEL_AGREE_MSG_ID = ORI_OFI_SEND_ASSET_CODE + DD + MM + YYYY + PAYMENT_SENDER_BIC
        let randomNumLen = 35 - RFI_CANCEL_AGREE_MSG_ID.length
        ...
        RFI_CANCEL_AGREE_MSG_ID = RFI_CANCEL_AGREE_MSG_ID + randomNum.toString()
