...
updateAWSSecret()
{
    VERSION=`cat ../../VERSION`
    echo $VERSION
    if [ $TRAVIS_BRANCH == 'dev-world-wire' ] && [ $TRAVIS_PULL_REQUEST == 'false' ]; then
        ENVIRONMENT="eksdev"
        MSKNAME="ww-dev-msk"
    ...
    elif [ $TRAVIS_BRANCH == 'qa-world-wire' ] && [ $TRAVIS_PULL_REQUEST == 'false' ]; then
        ENVIRONMENT="eksqa"
        MSKNAME="ww-qa-msk"
    ...
    elif [ $TRAVIS_BRANCH == 'staging-world-wire' ] && [ $TRAVIS_PULL_REQUEST == 'false' ]; then
        ENVIRONMENT="st"
        MSKNAME="ww-st-msk"
    ...
    elif [ $TRAVIS_BRANCH == 'test-world-wire' ] && [ $TRAVIS_PULL_REQUEST == 'false' ]; then
        ENVIRONMENT="pen"
        MSKNAME="ww-pen-msk"
    ...
    elif [ $TRAVIS_BRANCH == 'live-world-wire' ] && [ $TRAVIS_PULL_REQUEST == 'false' ]; then
        ENVIRONMENT="prod"
        MSKNAME="ww-prod-msk"
...
updateAPIGateway()
{
    ...
    do
        ...
        if [ $PARTICIPANTID == $OLDPARTICIPANTID ]; then
            ...
            printf "Ready to update AWS API-Gateway for %s on %s k8s cluster\n" "$D" "$TRAVIS_BRANCH"
    ...
    do
        ...
        do
          if [ $N == 'api' ]; then
              ...
              if [ $TRAVIS_BRANCH == 'live-world-wire' ]; then
